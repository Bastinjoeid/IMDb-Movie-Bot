...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('⭕️ Updates ⭕️', url='https://t.me/cinemahub00')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url=''),
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/cinemahub00'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/cinemahub00')
            ],[
            InlineKeyboardButton('❌ Close the Menu ❌', callback_data='close_data')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton('🎬 Series & Cinema Hub 🎬', url=f'https://t.me/cinemahub113')
        ]
        ]
    await client.send_cached_media(
        chat_id=message.from_user.id,
