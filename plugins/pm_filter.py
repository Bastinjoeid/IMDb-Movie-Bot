...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie Update", url="https://t.me/cinemahub1000"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/cinemahub113")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/cinemahub00'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/cinemahub1000')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movies 🎬', url=f'https://t.me/cinemahub113')
            ]
            ]
        await query.answer()
        await client.send_cached_media(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/cinemahub1000'),
            InlineKeyboardButton('CINEMA HUB ⭕️', url='https://t.me/cinemahub00')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/cinemahub00'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Movie", url="https://t.me/cinemahub00"),
        InlineKeyboardButton("Series ⭕️", url="https://t.me/cinemahub113")
    ])
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Group ⭕️",url="https://t.me/cinemahub00")
    ])
